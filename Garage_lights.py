...
var GARAGE_DOOR = {
  ...
  open: function() {
    ...
    cmd.run('sudo python /home/pi/HAP-NodeJS/python/tubes.py');
  ...
  identify: function() {
    console.log("Identify the Lights");
  }
};
...
garage
  ...
  .on('get', function(callback) {
    ...
    if (GARAGE_DOOR.opened) {
      console.log("Query: Are the lights ON? Yes.");
      callback(err, Characteristic.CurrentDoorState.OPEN);
    }
    else {
      console.log("Query: Are the lights ON? No.");
